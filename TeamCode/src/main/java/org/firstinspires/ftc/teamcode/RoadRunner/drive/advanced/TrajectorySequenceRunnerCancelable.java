...
public class TrajectorySequenceRunnerCancelable {
    ...
    DriveSignal update(Pose2d poseEstimate, Pose2d poseVelocity) {
        ...
        packet.put("cameraX", org.firstinspires.ftc.teamcode.Autonomous.AutoUtils.PoseStorage.cameraPosition.getX());
        packet.put("cameraY", PoseStorage.cameraPosition.getY());
