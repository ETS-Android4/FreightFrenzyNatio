...
//        packet.put("Back_Left", Hardware.back_left.getCurrentPosition());
        ...
        packet.put("slider left encoder value: ", Hardware.slider_right.getCurrentPosition());
        packet.put("slider right encoder value: ", Hardware.slider_left.getCurrentPosition());
